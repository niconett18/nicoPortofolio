...
import { Github, Linkedin, Mail, ExternalLink, Instagram, Sparkles, FileText, Code, Award, Globe, ArrowUpRight, UserCheck, Share2, User, MessageSquare, Send, ArrowRight, Youtube, MessageCircle } from "lucide-react";
...
const PROJECTS = [
  ...
  },
  {
    ...
    Img: "https://placehold.co/400x300/a855f7/ffffff?text=Kantin+Teknik",
  ...
  },
  {
    ...
    Img: "https://placehold.co/400x300/8b5cf6/ffffff?text=Video+Edits",
            ...
            <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
              ...
              <div className="relative">
                <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
                  ...
                  <img
                    src="https://placehold.co/400x400/6366f1/ffffff?text=Nicholas+Edmund"
                    alt="Profile"
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Ready to discuss your next project? Let's talk and make something amazing together.
                </p>
              </div>
    ...
    return (
      <div className="fixed inset-0 bg-[#030014] flex items-center justify-center z-50">
        <div className="text-center">
          <div className="w-20 h-20 border-4 border-[#6366f1] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
