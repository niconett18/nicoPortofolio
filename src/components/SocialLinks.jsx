...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/nicholas-edmund/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@niconet18",
    icon: Instagram,
    url: "https://www.instagram.com/niconet18/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@nicholasedmund",
    icon: Youtube,
    url: "https://www.youtube.com/@nicholasedmund",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "082112248933",
    icon: MessageCircle,
    url: "https://wa.me/6282112248933",
    color: "#25D366",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@nicholasedmund",
    color: "black",
...
const SocialLinks = () => {
  ...
  const [instagram, youtube, github, whatsapp, tiktok] = otherLinks;
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Third Row - GitHub, WhatsApp & TikTok */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[github, whatsapp, tiktok].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
